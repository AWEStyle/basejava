...
public class ResumeTestData {
    ...
    public static Resume resumeDefault(String uuid, String fullName){
        ...
        r.addSection(SectionType.PERSONAL,section4);
        r.addSection(SectionType.OBJECTIVE,section2);
        r.addSection(SectionType.ACHIEVEMENT,list);
        r.addSection(SectionType.QUALIFICATIONS,list2);

        r.addContact(ContactType.PHONE, "88005553535");
        r.addContact(ContactType.MOBILE, "89511619731");
        r.addContact(ContactType.HOME_PHONE, "663565");
        r.addContact(ContactType.SKYPE, "value");
        r.addContact(ContactType.MAIL, "value@mail.ru");
        return r;
    }
}
